...
def test_fetch_node_routes_web(monkeypatch, settings, web_query) -> None:
    ...
    state: SubgraphState = {"sub_query": web_query, "raw_content": "", "sub_result": None}
...
def test_fetch_node_routes_wiki(monkeypatch, settings, wiki_query) -> None:
    ...
    state: SubgraphState = {"sub_query": wiki_query, "raw_content": "", "sub_result": None}
    result = fetch_node(state, settings)
...
def test_fetch_node_routes_paper(monkeypatch, settings, paper_query) -> None:
    ...
    state: SubgraphState = {"sub_query": paper_query, "raw_content": "", "sub_result": None}
    result = fetch_node(state, settings)
...
def test_synthesize_node_returns_sub_result(settings, web_query) -> None:
    ...
    assert isinstance(result["sub_result"], SubResult)
...
def test_full_subgraph_produces_sub_result(monkeypatch, settings, wiki_query) -> None:
    ...
    assert final["sub_result"] is not None
    assert isinstance(final["sub_result"], SubResult)
